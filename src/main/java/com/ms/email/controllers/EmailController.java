...
//        return emailModelOptional.<ResponseEntity<Object>>map(emailModel ->
//                ResponseEntity.status(HttpStatus.OK).body(emailModel)).orElseGet(() -> ResponseEntity.status(HttpStatus.NOT_FOUND).body("Email not found."));
//    }
